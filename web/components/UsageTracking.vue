  ...
  <div class="space-y-4">
    ...
    <div v-else class="space-y-3">
      ...
      >
        <div class="flex items-center justify-between mb-2">
          ...
          <div class="flex items-center space-x-2">
            ...
            <span
              ...
              :class="getUsageTextColor(summary.percentage_used)"
            >
        ...
        <div
          v-if="summary.grace_window_status?.hasGraceWindow"
          class="mt-2 p-2 bg-blue-50 dark:bg-blue-900/20 rounded text-sm"
        >
          <div class="flex items-center">
            <UIcon
            ...
            <span class="text-blue-700 dark:text-blue-300">
              ...
              {{
                getGraceWindowTimeRemaining(
                  summary.grace_window_status.expiresAt
                )
              }}
            </span>
          </div>
        ...
        <div
          v-if="summary.percentage_used >= 80 && summary.percentage_used < 100"
          class="mt-2 p-2 bg-orange-50 dark:bg-orange-900/20 rounded text-sm"
        >
          <div class="flex items-center">
            <UIcon
        ...
        <div
          v-if="summary.percentage_used >= 100"
          class="mt-2 p-2 bg-red-50 dark:bg-red-900/20 rounded text-sm"
        >
          <div class="flex items-center">
            <UIcon
    ...
    <!-- Upgrade prompt -->
    <div
      v-if="hasApproachingLimits || hasExceededLimits"
      class="p-4 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-lg border border-orange-200 dark:border-orange-800"
    >
      <div class="flex items-start">
        <UIcon
          name="i-heroicons-sparkles"
          class="w-6 h-6 text-orange-500 mt-0.5 mr-3"
        />
        <div class="flex-1">
          ...
          <UButton color="orange" size="sm" class="mt-3" @click="handleUpgrade">
            Upgrade Plan
          </UButton>
        </div>
      </div>
...
const { usageSummary, loading, loadUsageSummary } = useUsageTracking();
...
const getCapabilityName = (capabilityKey: string): string => {
  ...
  return (
    nameMap[capabilityKey] ||
    capabilityKey.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())
  );
};
