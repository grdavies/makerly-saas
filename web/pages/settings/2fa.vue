  ...
  <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md mx-auto">
      <div class="text-center mb-8">
        <UIcon name="i-heroicons-shield-check" class="h-12 w-12 text-primary-600 mx-auto mb-4" />
      ...
      <UCard class="mb-6">
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center justify-between">
            <span class="text-sm font-medium text-gray-700">Required for Super Admin</span>
      ...
      <UCard v-if="!hasTOTP" class="mb-6">
        ...
        <div class="space-y-4">
          ...
          <UForm
            ...
            class="space-y-4"
          >
            <UFormGroup label="Enter 6-digit code from your authenticator app" name="code">
              <UInput
      ...
      <UCard v-if="hasTOTP">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-2">
            ...
            <div v-for="factor in factors" :key="factor.id" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                <p class="text-sm font-medium text-gray-900">{{ factor.friendly_name }}</p>
                <p class="text-xs text-gray-500">{{ factor.factor_type.toUpperCase() }}</p>
              </div>
              <UButton
                size="sm"
                color="red"
...
const confirmUnenroll = async (factorId: string) => {
  if (!confirm('Are you sure you want to remove this 2FA factor? This will make your account less secure.')) {
    return
  }
