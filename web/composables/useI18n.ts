...
export const useI18n = () => {
  ...
  const loadTeamPreferences = async () => {
    ...
    try {
      ...
      error.value =
        err instanceof Error ? err.message : 'Failed to load team preferences';
  ...
  const calculateEffectivePreferences = () => {
    ...
    const effective: I18NPreferences = {
      currency_code:
        userPreferences.value?.currency_code ||
        teamPreferences.value.currency_code,
      unit_family:
        userPreferences.value?.unit_family || teamPreferences.value.unit_family,
      date_format:
        userPreferences.value?.date_format || teamPreferences.value.date_format,
      time_format:
        userPreferences.value?.time_format || teamPreferences.value.time_format,
      timezone_id:
        userPreferences.value?.timezone_id || teamPreferences.value.timezone_id,
      number_format:
        userPreferences.value?.number_format ||
        teamPreferences.value.number_format,
    };
  ...
  watch([userPreferences, teamPreferences], calculateEffectivePreferences, {
    immediate: true,
  });
  ...
  const saveUserPreferences = async (preferences: Partial<I18NPreferences>) => {
    ...
    try {
      ...
      error.value =
        err instanceof Error ? err.message : 'Failed to save user preferences';
  ...
  const saveTeamPreferences = async (preferences: Partial<I18NPreferences>) => {
    ...
    try {
      ...
      error.value =
        err instanceof Error ? err.message : 'Failed to save team preferences';
  ...
  const resetUserPreferences = async () => {
    ...
    try {
      ...
      error.value =
        err instanceof Error ? err.message : 'Failed to reset user preferences';
  ...
  const initialize = async () => {
    await Promise.all([loadUserPreferences(), loadTeamPreferences()]);
  };
