      ...
      meta: [
        {
          name: 'description',
          content:
            'Professional inventory management platform for makers and small teams. Track inventory, manage manufacturing, and reconcile sales without wrestling spreadsheets.',
        },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        {
          property: 'og:title',
          content: 'Makerly - Inventory Management for Makers',
        },
        {
